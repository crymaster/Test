                                        ...
                                        if(extraParts.length >= 2){
                                            ...
                                            if(publisherParts.length==2)
                                                try {
                                                    ...
                                                    mLog.debug("[LoginJSON] Get partnerId from Google Play link. Malformed in publisherId value: publisherId(" + publisherParts[1] + ") login.device(" + login.device + ")");
                                                }
//                                                login.partnerId = 1;
                                        }
...
//                    login.debugSb.append(valueSb);                    
                ...
                encodingObj.put("vipId", login.vipId);
            }

 ...
 * @author thangtd
 */
public class XEEndRouletteJSON implements IMessageProtocol {

    private final Logger mLog = LoggerContext.getLoggerFactory().getLogger(XEEndRouletteJSON.class);
    ...
    public Object encode(IResponseMessage paramIResponseMessage) throws ServerException {
        try {
            ...
            XEEndRouletteResponse response = (XEEndRouletteResponse) paramIResponseMessage;

 ...
 * @author ThangTD
 */
public class XEBuyCashShopItemJSON implements IMessageProtocol {

    private final Logger mLog = LoggerContext.getLoggerFactory().getLogger(XEBuyCashShopItemJSON.class);
    ...
    public boolean decode(Object paramObject, IRequestMessage paramIRequestMessage) throws ServerException {
        try {
            ...
            XEBuyCashShopItemRequest req = (XEBuyCashShopItemRequest) paramIRequestMessage;
    ...
    public Object encode(IResponseMessage paramIResponseMessage) throws ServerException {
        try {
            ...
            XEBuyCashShopItemResponse response = (XEBuyCashShopItemResponse) paramIResponseMessage;

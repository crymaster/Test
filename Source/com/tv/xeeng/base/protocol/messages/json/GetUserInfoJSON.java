...
//                getUserInfo.mUid = jsonData.getLong("v");
    ...
    private String finalProtocol(GetUserInfoResponse getFrientList) {
        ...
        //Parse backward
        sb.append(getFrientList.vipId).append(AIOConstants.SEPERATOR_BYTE_1);
        ...
        if (PARTNER_APPSTORE_ID == getFrientList.partnerId && DBCache.appReviewVersion.equals(getFrientList.mobileVersion)) {

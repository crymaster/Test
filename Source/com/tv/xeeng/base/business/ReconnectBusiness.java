...
public class ReconnectBusiness extends AbstractBusiness {
    ...
    private static final Logger mLog = LoggerContext.getLoggerFactory()
            .getLogger(ReconnectBusiness.class);
    ...
    public int handleMessage(ISession aSession, IRequestMessage aReqMsg,
        ...
        try {
            ...
            newUser = cacheUser.getUserInfo(aSession.getUID());
            ...
            switch (rqReconn.type) {
                ...
                case 4: {// match
                    ...
                    if (matchEntity == null || matchEntity.getRoom() == null) {
                        ...
                        aSession.setUserEntity(newUser);
                        enterRoom(aSession, rqReconn.phong, rqReconn.zone,
                                resReconn);
                        return 1;
                    }
                    ...
                    switch (zoneID) {
						...
						// Room r =
                                // reconnPlayer.currentSession.getJoinedRooms().lastElement();
    ...
    private void enterRoom(ISession aSession, int roomID, int zoneID,
    ...
    private void joinTable(ISession s, int game, long matchID)
            throws TienLenException, ServerException,

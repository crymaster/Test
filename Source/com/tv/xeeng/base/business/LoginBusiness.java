...
//                                    resLogin.setLastMatch(curMatchID);
                ...
                resLogin.vipId = user.vipId;

                if (lVer != null && !rqLogin.mobileVersion.equals(lVer.desc) && 
                        aSession.getDeviceType() == AIOConstants.ANDROID_DEVICE && rqLogin.partnerId == 96) { // && aSession.getDeviceType() != AIOConstants.ANDROID_DEVICE

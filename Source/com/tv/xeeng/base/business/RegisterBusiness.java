...
public class RegisterBusiness extends AbstractBusiness {
    ...
    public int handleMessage(ISession aSession, IRequestMessage aReqMsg,
        ...
        try {
            ...
            if (uid == -1) {
                resRegister.setFailure(ResponseCode.FAILURE, "Tài khoản hoặc tên nhân vật đã có người đăng ký, bạn vui lòng đăng ký tài khoản hoặc tên nhân vật khác!");
            } else {
                aSession.setLastRegister(System.currentTimeMillis());

                int rnd = (int) (Math.random() * 3);

                int money = rnd == 0 ? 30000 : (rnd == 1 ? 20000 : 10000);

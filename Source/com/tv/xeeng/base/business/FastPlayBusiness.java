...
public class FastPlayBusiness extends AbstractBusiness {
    ...
    private static final Logger mLog = LoggerContext.getLoggerFactory().getLogger(FastPlayBusiness.class);
    ...
    public int handleMessage(ISession aSession, IRequestMessage aReqMsg, IResponsePackage aResPkg) {
        ...
        mLog.debug("[FAST PLAY]: Catch " + aSession.getUID());

//        FastPlayRequest rqfP = (FastPlayRequest) aReqMsg;
//        resfP.session = aSession;

//        resfP.setFailure(ResponseCode.FAILURE, "Tính năng đang được bảo trì. Bạn vui lòng thử lại sau!");
//        try {
...
//        return 1;
        try {
            ...
            if (currentTime - aSession.getLastFP() < MAX_BETWEEN_TWO_REQUEST && aSession.getLastFP() > 0) {
                resfP.setFailure(ResponseCode.FAILURE, MAX_TWO_REQUEST);
                try {
                    aSession.write(resfP);
                } catch (ServerException ex) {
                    mLog.error("fast playing ", ex);
                ...
                mLog.error("FAST PLAY TOO FAST: " + aSession.getUID());
            ...
            if (res == null) {
                ...
                newRequest.tableIndex = (int) phongAvailable.getAvailableTable();
                ...
                aSession.setLastFP(System.currentTimeMillis());
         ...
         //rqJoin.uid = aSession.getUID();
            ...
            resfP.setFailure(ResponseCode.FAILURE, be.getMessage());
            try {

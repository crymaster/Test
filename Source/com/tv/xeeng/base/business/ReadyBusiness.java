        ...
        try {
            ...
            if (room != null) {
                ...
                switch (aSession.getCurrentZone()) {
                    /*
                     * case ZoneID.PHOM: case ZoneID.TIENLEN: case
                     * ZoneID.NEW_BA_CAY: case ZoneID.BAU_CUA_TOM_CA: case
                     * ZoneID.AILATRIEUPHU: case ZoneID.PIKACHU:
                     */
                    default: {

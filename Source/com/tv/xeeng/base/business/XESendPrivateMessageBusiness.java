...
public class XESendPrivateMessageBusiness extends AbstractBusiness {
    ...
    private static final Logger mLog = LoggerContext.getLoggerFactory().getLogger(XESendPrivateMessageBusiness.class);
    ...
    public int handleMessage(ISession aSession, IRequestMessage aReqMsg, IResponsePackage aResPkg) {
        ...
        XEPrivateMessageEntity pm = new XEPrivateMessageEntity(aSession.getUID(), rq.getToUserId(), rq.getTitle(), rq.getContent());
        boolean success = false;
        try {
            success = XEDataUtils.insertPrivateMessage(pm);

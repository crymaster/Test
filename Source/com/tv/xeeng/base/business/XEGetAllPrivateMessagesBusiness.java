...
public class XEGetAllPrivateMessagesBusiness extends AbstractBusiness {
    ...
    private static final Logger mLog = LoggerContext.getLoggerFactory().getLogger(XEGetAllPrivateMessagesBusiness.class);
...
//        } else {
        ...
        try {
            lstPM = XEDataUtils.getAllPrivateMessages(aSession.getUID(), NUM_OF_DAY);

...
public class XEGetPrivateMessageBusiness extends AbstractBusiness {
    ...
    private static final Logger mLog = LoggerContext.getLoggerFactory().getLogger(XEGetPrivateMessageBusiness.class);
    ...
    public int handleMessage(ISession aSession, IRequestMessage aReqMsg, IResponsePackage aResPkg) {
        ...
        try {
            pm = XEDataUtils.getPrivateMessage(rq.getPmId());

...
public class SimpleWorkflow implements IWorkflow {
    ...
    public void startDB() throws Exception {
        ...
        try {
            ...
            DBCache.isRouletteEvent = this.mWorkflowConfig.isRouletteEvent();
            DBCache.badUserId = this.mWorkflowConfig.getBadUserId();
            DBCache.appReviewVersion = this.mWorkflowConfig.getAppReviewVersion();
            DBCache.isMaintenance = this.mWorkflowConfig.isMaintenance();

            this.mLog.info("[WF] BAD_USER_ID " + DBCache.badUserId);
            this.mLog.info("[WF] APP_REVIEW_VERSION " + DBCache.appReviewVersion);

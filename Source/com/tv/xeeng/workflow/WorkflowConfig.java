...
public class WorkflowConfig {
    ...
    WorkflowConfig() throws ServerException {
    ...
    public boolean isRouletteEvent() {
        return this.mConfig.getBoolean("workflow.rouletteEvent");
    }

    public long getBadUserId() {
        return this.mConfig.getLong("workflow.badUserId");
    }

    public String getAppReviewVersion() {
        return this.mConfig.getString("workflow.appReviewVersion");
    }
    
    public boolean isMaintenance() {
        return this.mConfig.getBoolean("workflow.maintenance");
    }

...
public class EventGiftsDB {
    ...
    public static void reload() {
        try {
            ...
            mLog.debug("[EVENT GIFTS] : " + itemsList.size() + " gifts");
        ...
        try {
            ...
            if (rs != null) {
                while (rs.next()) {
                    ...
                    EventGiftEntity entity = new EventGiftEntity(evitCode, evgfCode, name, description, rate, value, type, quantity, isLimitUsage, eventId);
                    res.add(entity);
                }

...
public class InventoryDB {
    ...
    public static List<InventoryItemEntity> getUserInventory(long uid) throws SQLException {
    ...
    private static List<InventoryItemEntity> getUserInventoryFromDB(long uid) throws SQLException {

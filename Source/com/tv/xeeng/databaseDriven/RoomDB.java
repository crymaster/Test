 ...
 */
public class RoomDB {
    private static final Logger logger = LoggerContext.getLoggerFactory().getLogger(RoomDB.class);
    public static Map<Integer, List<NRoomEntity>> lstRooms = new HashMap<>();
    ...
    private static void initAllRooms() throws SQLException, IllegalArgumentException, IllegalAccessException {
        ...
        logger.debug("[DUMPING lstRooms]");
        DebugUtils.dump(lstRooms);
    }

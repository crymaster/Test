...
public abstract class SimpleTable {
    ...
    public static final Logger mLog = LoggerContext.getLoggerFactory().getLogger(SimpleTable.class);
...
//        try {
        ...
        if (playerRoom == null || (playerRoom != null && playerRoom.getAttactmentData().matchID == this.matchID)) {
            if (response instanceof TurnResponse || response instanceof GetPokerResponse
                    || response instanceof ReadyResponse || response instanceof EndMatchResponse
                    || response instanceof CancelResponse
                    || response instanceof JoinedResponse || response instanceof StartResponse 
...
//                    msgFactory = owner.currentSession.getMessageFactory();
    ...
    public abstract List<? extends SimplePlayer> getNewPlayings();

    public abstract List<? extends SimplePlayer> getNewWaitings();

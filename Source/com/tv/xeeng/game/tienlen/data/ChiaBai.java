...
public class ChiaBai {
    ...
    private Couple<ArrayList<Integer>, ArrayList<Integer>> tuquy3() {
        ArrayList<Integer> res = new ArrayList<>();
        // tk3
        res.add((new Poker(3, PokerType.Hearts)).toInt());
        res.add((new Poker(3, PokerType.Diamonds)).toInt());
        res.add((new Poker(3, PokerType.Clubs)).toInt());
        res.add((new Poker(3, PokerType.Spades)).toInt());
    ...
    private Couple<ArrayList<Integer>, ArrayList<Integer>> tuquy2() {
        ArrayList<Integer> res = new ArrayList<>();
        // tk3
        res.add((new Poker(2, PokerType.Hearts)).toInt());
        res.add((new Poker(2, PokerType.Diamonds)).toInt());
        res.add((new Poker(2, PokerType.Clubs)).toInt());
        res.add((new Poker(2, PokerType.Spades)).toInt());

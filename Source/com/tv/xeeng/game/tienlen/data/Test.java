...
public class Test {
	public static void main(String[] args){
		Poker[] p = new Poker[5];
		p[0] = new Poker(10, PokerType.Hearts);
		p[1] = new Poker(5, PokerType.Spades);
		p[2] = new Poker(9, PokerType.Hearts);
		p[3] = new Poker(5, PokerType.Hearts);
		p[4] = new Poker(13, PokerType.Hearts);
		quicksort(0, 4, p);
		System.out.println();
	}
